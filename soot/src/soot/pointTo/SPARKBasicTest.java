...
public class SPARKBasicTest {
    public static String processDir = "E:\\codes\\homework\\soot-tools\\soot-tools\\soot\\target\\classes";
...
//        Options.v().set_app(true);
        ...
        String mainClass = "soot.pointTo.Test1";
        loadClass("soot.pointTo.Item",false);
        loadClass("soot.pointTo.Container",false);
